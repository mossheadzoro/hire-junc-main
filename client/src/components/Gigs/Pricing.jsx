        ...
        <div className="sticky top-36 mb-10 h-max w-96">
          <div className="border p-10 flex flex-col gap-5">
            ...
            <ul className="flex gap-1 flex-col">
              {gigData.features.map((feature) => (
                <li key={feature} className="flex items-center gap-3">
                  <BsCheckLg className="text-[#219dad] text-lg" />
            ...
            {gigData.userId === userInfo?.id ? (
              <button
                className="flex items-center bg-[#219dad] text-white py-2 justify-center font-bold text-lg relative rounded"
          ...
          {gigData.userId !== userInfo?.id && (
            <div className="flex items-center justify-center mt-5">
              <button className="flex gap-2 items-center justify-center w-5/6 hover:bg-[#74767e] py-1 border border-[#74767e] px-5 text-[#6c6d75] hover:text-white transition-all duration-300 text-lg rounded font-bold">
