    ...
    <div className="min-h-[80vh] my-10 mt-0 px-32">
      ...
      <div className="relative overflow-x-auto shadow-md sm:rounded-lg">
        <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
          ...
          <tbody >
            {gigs.map(({ title, category,mainCategory, price, deliveryTime, id }) => {
              return (
                <tr
                  className=" bg-white dark:bg-[#5c7474] hover:bg-gray-50 dark:hover:bg-gray-500   dark:text-white"
                  key={id}
                >
                  <th
                    scope="row"
                  ...
                  <td className="px-6 py-4 text-right">
                    <Link
                      href={`/seller/gigs/${id}`}
                      className="font-medium text-blue-600 dark:text-blue-500 dark:bg-blue-100 px-4 py-2 hover:bg-blue-300  hover:text-blue-800 rounded-full"
                    >
                      Edit
                    </Link>
                  </td>
